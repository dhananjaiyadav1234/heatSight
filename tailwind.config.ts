		...
		extend: {
			colors: {
				...
				heat: {
					...
					'safe-foreground': 'hsl(var(--heat-safe-foreground))',
					mild: 'hsl(var(--heat-mild))',
					'mild-foreground': 'hsl(var(--heat-mild-foreground))',
					high: 'hsl(var(--heat-high))',
					'high-foreground': 'hsl(var(--heat-high-foreground))',
					extreme: 'hsl(var(--heat-extreme))',
					'extreme-foreground': 'hsl(var(--heat-extreme-foreground))'
				},
				cool: {
